def print_args(args):
    ...
    if args.task_name in ['long_term_forecast', 'short_term_forecast']:
        ...
        print(f'  {"Is Time Encoder":<20}{args.time_encoder:<20}')
    ...
    print(f'  {"C Out:":<20}{args.c_out:<20}{"C In:":<20}{args.c_in:<20}')
    print(f'  {"n heads:":<20}{args.n_heads:<20}{"e layers:":<20}{args.e_layers:<20}')
    print(f'  {"d model:":<20}{args.d_model:<20}{"d FF:":<20}{args.d_ff:<20}')
    print(f'  {"d core:":<20}{args.d_core:<20}{"is_use_ada_st:":<20}{args.is_use_adaptive_stride:<20}')
    print(f'  {"local_and_global_adaptive_level:":<40}{args.local_and_global_adaptive_level:<5}')
    print(f'  {"channel_mix_information_adaptive_level:":<40}{args.channel_mix_information_adaptive_level:<5}')
    print(f'  {"local_and_global_parallel_or_serial:":<40}{args.local_and_global_parallel_or_serial:<5}')
    print(f'  {"channel_mix_information_parallel_or_serial:":<40}{args.channel_mix_information_parallel_or_serial:<5}')
    print(f'  {"unit_patch_len:":<20}{args.unit_patch_len:<20}{"stride:":<20}{args.stride:<20}')
    ...
    print(f'  {"learning_rate:":<20}{args.learning_rate:<20}{"Dropout:":<20}{args.dropout:<20}')
    print()
